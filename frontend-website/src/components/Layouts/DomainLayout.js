...
const DomainLayout = (props) => {
    ...
    to: `/domains/${urlParams.singleDomainId}/domains`,
  }
            ]
        }
    ];
...
const mapState = (state) => {
    ...
    return { selectedDomain, menuOpen };
  };
  const mapDispatch = (dispatch) => ({
    setMenuOpen: (bool) => dispatch.layout.setMenuOpen(bool),
    getOneDomain: (id) => dispatch.domain.getOneDomain(id),
  });

export default connect(mapState, mapDispatch)(DomainLayout);
