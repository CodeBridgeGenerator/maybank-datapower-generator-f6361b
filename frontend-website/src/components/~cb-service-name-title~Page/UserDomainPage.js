...
const ~cb-service-name-singular-title~UserPage = (props) => {
  return (
    <UserLayout>
          ...
          >
            <div className="flex align-items-center text-white">
              <p className="text-4xl text-white">
                {props.selectedUser?.name + " > "} ~cb-service-label~
              </p>
            </div>
          </div>
...
export default connect(mapState, mapDispatch)(~cb-service-name-singular-title~UserPage);