...
const typeArray = ["dom","xpath","xslt"];
...
const XmlsCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        ...
        const result = await client.service("xmls").create(_data);
        ...
        props.onHide();
        props.alert({ type: "success", title: "Create info", message: "Info xmls updated successfully" });
    ...
    return (
        <Dialog header="Create" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div role="xmls-create-dialog-component">
            <div>
...
export default connect(mapState, mapDispatch)(XmlsCreateDialogComponent);
