...
const HeadersCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        ...
        props.onHide();
        props.alert({ type: "success", title: "Create info", message: "Info headers updated successfully" });
    ...
    return (
        <Dialog header="Create" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div role="headers-create-dialog-component">
            <div>
            ...
            <div>
                <p className="m-0">healthport:</p>
                <InputText type="number" className="w-full mb-3" value={_entity?.healthport} onChange={(e) => setValByKey("healthport", e.target.value)}  />
            </div>
            <div>
