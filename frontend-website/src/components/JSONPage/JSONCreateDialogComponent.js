...
const typeArray = ["extra","inputVars"];
...
const JSONCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        ...
        const result = await client.service("jSON").create(_data);
        ...
        props.onHide();
        props.alert({ type: "success", title: "Create info", message: "Info jSON updated successfully" });
    ...
    return (
        <Dialog header="Create" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div role="jSON-create-dialog-component">
            <div>
                <p className="m-0">Domain.JSON:</p>
...
export default connect(mapState, mapDispatch)(JSONCreateDialogComponent);
