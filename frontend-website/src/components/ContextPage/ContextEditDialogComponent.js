...
const ContextCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        ...
        await client.service("context").patch(_entity._id, _data);
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info context updated successfully" });
    ...
    return (
        <Dialog header="Edit Info" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div role="context-edit-dialog-component">
                <div>
