...
const SingleFileOpenPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("fileOpen")
            .get(urlParams.singleFileOpenId, { query: { $populate: ["domainId"] }})
            .then((res) => {
                set_entity(res || {});
    ...
    const goBack = () => {
        navigate("/fileOpen", { replace: true });
    };
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-10">
                <div className="flex align-items-center justify-content-start">
                    ...
                    <h3 className="m-0">FileOpen</h3>
                </div>
                <p>fileOpen/{urlParams.singleFileOpenId}</p>
            </div>
...
export default connect(mapState, mapDispatch)(SingleFileOpenPage);
